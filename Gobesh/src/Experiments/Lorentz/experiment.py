"""The Lorentz experiment illustration as given in the manual

The state machine is described as

wait      ---gcontroller.go---> computing
          ---gcontroller.quit---> quit

computing ---gcontroller.abort---> wait
          ---lorentz.done--> run_done
         
run_done  ---controller.next_run---> computing
...
gobesh.start_experiment_server(ExperimentName, StateMachine, DeviceDefinitions)